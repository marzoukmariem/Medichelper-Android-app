...
public class RendezVousAdapterDocteur extends ArrayAdapter<RendezVous>{
    Context context;
    List<RendezVous> contacts;
    int resources;
    public RendezVousAdapterDocteur(@NonNull Context context, int resource, @NonNull List<RendezVous> objects) {
